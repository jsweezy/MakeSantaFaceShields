...
$d1=0.2; # first empty layer height
$d2=0.2; # interface layer height
$d3=0.0; # second empty layer height
$d4=0.2; # last layer

$t1 = 180; # temperature of interface layer
$t2 = 195; # temperature of first layer after interface layer 
$t3 = 215; # temperature of all other layers
...
print  <<EOFB;
  <range min_z="$x1" max_z="$x3">
   <option opt_key="bottom_solid_layers">0</option>
   <option opt_key="bridge_flow_ratio">1</option>
   ...
   <option opt_key="infill_overlap">100%</option>
...
print  <<EOFC;
  <range min_z="$x3" max_z="$x4">
   <option opt_key="bottom_fill_pattern">rectilinear</option>
   <option opt_key="bottom_solid_layers">0</option>
   <option opt_key="bridge_flow_ratio">1</option>
   <option opt_key="bridge_speed">15</option>
   <option opt_key="external_perimeter_speed">15</option>
   <option opt_key="external_perimeters_first">0</option>
   <option opt_key="extruder">0</option>
   <option opt_key="fill_density">100%</option>
   <option opt_key="fill_pattern">rectilinear</option>
   <option opt_key="gap_fill_speed">30</option>
   <option opt_key="infill_overlap">50%</option>
   <option opt_key="infill_speed">30</option>
   <option opt_key="layer_height">0.3</option>
   <option opt_key="overhangs">1</option>
